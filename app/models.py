...
class TipoMedida(ModeloBase):
    """
    Modelo que representa tipos de medidas en el sistema.
    
    Este modelo hereda de ModeloBase y almacena información sobre diferentes
    tipos de medidas que pueden utilizarse en la aplicación.
    
    Attributes:
        nombre (CharField): Nombre del tipo de medida con un máximo de 100 caracteres.
    
    Meta:
        verbose_name (str): Nombre singular para la interfaz administrativa ('Tipo de medida').
        verbose_name_plural (str): Nombre plural para la interfaz administrativa ('Tipos de medidas').
    """
    nombre = models.CharField(max_length=100, help_text="Nombre del tipo de medida")

    class Meta:
        """
        Representación en cadena de texto del tipo de medida.
        
        Returns:
            str: El nombre del tipo de medida.
        """
